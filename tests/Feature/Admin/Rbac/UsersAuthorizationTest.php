...
{
    public function test_users_index_denies_without_permission(): void
    {
        $response = $this->withAdminPermissions([])->get('/admin/users');
        $response->assertForbidden();
    }

    public function test_users_index_allows_with_permission(): void
    {
        $response = $this->withAdminPermissions(['module.users.list'])->get('/admin/users');
