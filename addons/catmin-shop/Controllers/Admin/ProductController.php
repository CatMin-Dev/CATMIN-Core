...
class ProductController extends Controller
{
    ...
    {
        return view()->file(base_path('addons/catmin-shop/Views/index.blade.php'), [
            'currentPage' => 'shop',
    ...
    {
        return view()->file(base_path('addons/catmin-shop/Views/create.blade.php'), [
            'currentPage' => 'shop',
            'categories' => $this->shopAdminService->activeCategories(),
    ...
    public function edit(Product $product): View
    {
        ...
        return view()->file(base_path('addons/catmin-shop/Views/edit.blade.php'), [
            'currentPage' => 'shop',
            'product' => $product,
            'categories' => $this->shopAdminService->activeCategories(),
            'visibilityOptions' => $this->shopAdminService->visibilityOptions(),
