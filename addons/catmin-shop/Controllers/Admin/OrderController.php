...
class OrderController extends Controller
{
    ...
    {
        return view()->file(base_path('addons/catmin-shop/Views/orders/index.blade.php'), [
            'currentPage' => 'shop',
    ...
    {
        return view()->file(base_path('addons/catmin-shop/Views/orders/create.blade.php'), [
            'currentPage' => 'shop',
    ...
    public function show(Order $order): View
    {
        ...
        return view()->file(base_path('addons/catmin-shop/Views/orders/show.blade.php'), [
            'currentPage' => 'shop',
            'order' => $order,
