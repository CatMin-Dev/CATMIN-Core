...
use Addons\CatminShop\Models\InvoiceSettings;
...
class InvoiceController extends Controller
{
    public function show(Invoice $invoice): View
    {
        ...
        return view()->file(base_path('addons/catmin-shop/Views/invoices/show.blade.php'), [
            'currentPage' => 'shop',
            'invoice' => $invoice,
            'order' => $invoice->order,
    ...
    {
        return view()->file(base_path('addons/catmin-shop/Views/invoices/settings.blade.php'), [
            'currentPage' => 'shop',
            'settings' => InvoiceSettings::current(),
        ]);
    }
    ...
    public function downloadPdf(Invoice $invoice): Response
    {
        ...
        $html = view()->file(base_path('addons/catmin-shop/Views/invoices/show.blade.php'), [
            'currentPage' => 'shop',
            'invoice' => $invoice,
            'order' => $invoice->order,
            'customer' => $invoice->customer,
