...
[![Version](https://img.shields.io/badge/version-0.5.0--RC.6-e23561)](https://github.com/CatMin-Dev/CATMIN-Core/releases/tag/0.5.0-RC.6)
...
CATMIN `0.5.0-RC.6` - core standalone avec CRON backup/logs refactorisé et maintenance recentrée sur les logs globaux.
