...
[![Version](https://img.shields.io/badge/version-0.5.0--RC.3-e23561)](https://github.com/CatMin-Dev/CATMIN-Core/releases/tag/0.5.0-RC.3)
...
CATMIN `0.5.0-RC.3` - core standalone avec maintenance/backups fiabilisés, diagnostics d'échec renforcés et UI FR harmonisée.
