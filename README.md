...
[![Version](https://img.shields.io/badge/version-0.5.0--RC.2-e23561)](https://github.com/CatMin-Dev/CATMIN-Core/releases/tag/0.5.0-RC.2)
...
CATMIN `0.5.0-RC.2` - core standalone avec front core loader officiel et sous-systeme maintenance/backups/restore RC1.
