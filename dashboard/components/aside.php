            ...
            <div class="navbar nav_title border-0">
              <a href="index.php?page=dashboard" class="site_title">
                ...
                <div class="site_brand_text">
                  ...
                  <small class="site_brand_subtitle">Admin Miaoude Simple</small>
                </div>
                <small class="site_brand_compact">AMS</small>
              </a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="bi bi-bag"></i> Comercial <span class="bi bi-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=e_commerce">eCommerce</a></li>
                      <li><a href="index.php?page=invoice">Invoice</a></li>
                      <li><a href="index.php?page=pricing_tables">Pricing Tables</a></li>
                    </ul>
                  </li>
                  <li><a><i class="bi bi-ui-checks"></i> Miscellaneous <span class="bi bi-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=widgets">Widgets</a></li>
                      <li><a href="index.php?page=map">Map</a></li>
                      <li><a href="index.php?page=profile">Profile</a></li>
                      <li><a href="index.php?page=projects">Projects</a></li>
                      <li><a href="index.php?page=project_detail">Project Details</a></li>
                      <li><a href="index.php?page=typography">Typography</a></li>
                      <li><a href="index.php?page=plain_page">Plain Page</a></li>
