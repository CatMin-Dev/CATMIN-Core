...
<html lang="en" data-theme="catmin-light">
  <head>
    ...
    <!-- Vendor icon & UI libraries (loaded independently of main.css) -->
    <link rel="stylesheet" href="assets/css/@fortawesome/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="assets/css/bootstrap-icons/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="assets/css/@eonasdan/tempus-dominus/dist/css/tempus-dominus.min.css">
    <link rel="stylesheet" href="assets/css/leaflet/dist/leaflet.css">
    <link rel="stylesheet" href="vendor/node_modules/@simonwep/pickr/dist/themes/classic.min.css">
    <link rel="stylesheet" href="vendor/node_modules/@simonwep/pickr/dist/themes/monolith.min.css">
    <link rel="stylesheet" href="vendor/node_modules/@simonwep/pickr/dist/themes/nano.min.css">
    <link rel="stylesheet" href="assets/css/themes.css">
    <link rel="stylesheet" href="assets/css/catmin.css">

    <script src="assets/js/vendor/browser-globals-shim.js"></script>
    <!-- Cropper.js library - load UMD version directly for better compatibility -->
    <script src="/rework/vendor/node_modules/cropperjs/dist/cropper.min.js"></script>
    <script type="importmap">
{
  "imports": {
    ...
    "cropperjs": "/rework/assets/js/vendor/cropper-adapter.js",
