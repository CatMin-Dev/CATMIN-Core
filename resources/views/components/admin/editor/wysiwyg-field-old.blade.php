    ...
    @if ($enabled)
        <div class="catmin-editor border rounded" data-catmin-editor data-editor-input="{{ $id }}">
            <div class="catmin-editor-toolbar border-bottom p-2 d-flex flex-wrap gap-1" role="toolbar" aria-label="Toolbar editeur">
                ...
                <label class="btn btn-sm btn-outline-secondary mb-0" title="Couleur texte">
                    <i class="bi bi-palette"></i>
                    <input type="color" class="d-none" data-editor-cmd="foreColor">
                </label>
                @endif
                @if($hasTool('bg-color'))
                <label class="btn btn-sm btn-outline-secondary mb-0" title="Couleur fond">
                    <i class="bi bi-paint-bucket"></i>
                    <input type="color" class="d-none" data-editor-cmd="hiliteColor">
                </label>
                @endif
                ...
                <button type="button" class="btn btn-sm btn-outline-info" data-editor-action="preview" title="Aperçu"><i class="bi bi-eye me-1"></i>Preview</button>
            ...
            <div class="catmin-editor-body position-relative d-flex">
                ...
                <aside class="catmin-editor-panel border-start" data-editor-panel @if(!$hasTool('panel')) hidden @endif>
                    <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                        <h6 class="mb-0">Bibliotheque editor</h6>
                    ...
                    <div class="p-3 border-bottom">
                        <div class="btn-group w-100" role="group" aria-label="Volets bibliotheque editor">
...
<!-- Preview Modal -->
<div class="modal fade" id="editor-preview-modal-{{ $id }}" tabindex="-1" aria-labelledby="editor-preview-title-{{ $id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editor-preview-title-{{ $id }}">Aperçu</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>
            <div class="modal-body">
                <div class="bg-light p-4 rounded" data-editor-preview-content id="editor-preview-{{ $id }}"></div>
            </div>
        </div>
    </div>
</div>
