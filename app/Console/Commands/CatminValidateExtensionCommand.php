...
class CatminValidateExtensionCommand extends Command
{
    protected $signature = 'catmin:validate-extension
        {slug : Module slug}
        {--json : sortie JSON complete}';

    protected $description = 'Valide le contrat d architecture d un module CATMIN';
    ...
    public function handle(): int
    {
        ...
        $report = $this->validator->validateModule($slug);
        ...
        $this->info('CATMIN Module Contract Validation');
        $this->line('- Module: ' . (string) ($report['slug'] ?? $slug));
