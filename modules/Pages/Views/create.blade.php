...
<x-admin.crud.page-header
    ...
    subtitle="Titre, contenu enrichi et paramètres SEO."
>
...
<div class="catmin-page-body">
    ...
    <form method="post" action="{{ admin_route('pages.store') }}" id="page-form">
        @csrf
        ...
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-primary" type="submit">
                <i class="bi bi-check2-circle me-1"></i>Créer la page
            </button>
