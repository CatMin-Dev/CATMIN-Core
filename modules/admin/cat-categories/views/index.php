...
<section class="cat-module-stats mb-3">
  <div class="cat-module-stat-col"><div class="card h-100"><div class="card-body"><p class="small text-body-secondary mb-1"><?= htmlspecialchars((string) ($tr['total_categories'] ?? 'Total categories'), ENT_QUOTES, 'UTF-8') ?></p><p class="h3 mb-0"><?= (int) ($stats['total_categories'] ?? 0) ?></p></div></div></div>
  ...
  <div class="cat-module-stat-col"><div class="card h-100"><div class="card-body"><p class="small text-body-secondary mb-1"><?= htmlspecialchars((string) ($tr['root_categories'] ?? 'Root categories'), ENT_QUOTES, 'UTF-8') ?></p><p class="h3 mb-0"><?= (int) ($stats['root_categories'] ?? 0) ?></p></div></div></div>
</section>
