...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-9">
        <div class="card mb-4">
            <div class="card-body">
                <h2 class="h5 mb-1">Paramètres · Contract demo</h2>
                <p class="text-body-secondary mb-0">
                    Panneau de réglages du module exemple, intégré dans la navigation Paramètres.
                    Accessible avec la permission <code>example.settings</code>.
                </p>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        <h3 class="h6 mb-2"><i class="bi bi-sliders text-primary me-1"></i> Route settings</h3>
                        <code class="small">GET /settings/contract-demo</code>
                        <p class="text-body-secondary small mt-2 mb-0">
                            Route chargée depuis <code>routes/settings.php</code>, zone admin, via le multi-zone loader.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="text-body-secondary small mt-2 mb-0">
                            Accès restreint — seul un rôle ayant <code>example.settings</code> peut accéder à cette page.
                        </p>
                    </div>
                </div>
            </div>
